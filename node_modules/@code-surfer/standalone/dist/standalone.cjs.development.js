...
var stepParser = require('@code-surfer/step-parser');
...
function CodeSurferContent(_ref2) {
  ...
  var unfocusedStyle = themes.useUnfocusedStyle();
  return React.createElement(themes.Styled.Pre, {
  ...
  }, React.createElement(themes.Styled.Code, {
...
function InnerCodeSurfer(_ref) {
  ...
  var _React$useMemo = React.useMemo(function () {
    ...
    return stepParser.parseSteps(inputSteps);
...
function CodeSurferWrapper(_ref2) {
  ...
  if (wait) return React.createElement(themes.StylesProvider, {
    theme: theme
  }, React.createElement(themes.Styled.Placeholder, null));
  return React.createElement(themes.StylesProvider, {
    theme: theme
  }, React.createElement(InnerCodeSurfer, Object.assign({}, props)));
}

exports.CodeSurfer = CodeSurferWrapper;
exports.UnknownError = UnknownError;
//# sourceMappingURL=standalone.cjs.development.js.map
